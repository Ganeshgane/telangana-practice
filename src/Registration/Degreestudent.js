...
const Degreestudent = () => {
  ...
  const handleChange4 = (event) => {
    ...
    const validationSchema = Yup.object().shape({
      ...
      currentyear : Yup.string().required('Enter currentyear'),
    ...
    const {
      ...
      <div class="d-none d-md-block">
          ...
          <Paper elevation={10} style={paperStyle}   sx={{ width: 1 }}  mx={{ width: 3/4 }}  lg={{ width: 1/2 }}>
            <Typography variant="h5" style={{backgroundColor:"blue", margin:"10px 0px 20px", color:"white", textAlign:"center"}}>Degree Student Registration</Typography>
            <Box px={3} py={2}  style={{margin:"5% 10%"}}>
              ...
              <Grid container spacing={1}>         
                ...
                <Typography variant="h6" margin="dense" fullWidth style={{backgroundColor: "blue", margin:"10px 0px 5px ", color:"white"}}>
                 CONTACT DETAILS
                </Typography>
                <Grid container spacing={1}>
                <Grid item xs={12} sm={6} lg={4}>
            ...
            <Typography variant="h6" margin="dense" style={{backgroundColor: "blue", color:"white", margin:"10px 0px 20px "}}>
                 EDUCATIONAL DETAILS
              </Typography>
              <Grid container spacing={1}>         
                <Grid item xs={12} sm={6} lg={4}>
