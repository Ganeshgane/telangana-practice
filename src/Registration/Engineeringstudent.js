...
const Engineeringstudent = () => {
  ...
  const handleChange5 = (event) => {
    ...
    const validationSchema = Yup.object().shape({
      ...
      currenteducation : Yup.string().required('select currenteducation'),
      ...
      pincode : Yup.string().required('Pincode  is required')
          .matches(/^[0-9]+$/, "Must be only digits"),
      mobilenumber : Yup.string().required('house number is required')
          .matches(/^[0-9]+$/, "Must be only digits")   
          ...
          <Paper elevation={10} style={paperStyle}   sx={{ width: 1 }}  mx={{ width: 3/4 }}  lg={{ width: 1/2 }}>
            ...
            <Typography variant="h6" margin="dense" style={{backgroundColor: "blue", color:"white",margin:"10px 0px 15px 0px"}}>
              ...
              <Grid container spacing={1}>         
                ...
                <Grid item xs={12} sm={6} lg={4}>
                    <FormControl fullWidth>
                    <InputLabel id="demo-simple-select-label">Current Education</InputLabel>
                    <Select
                      labelId="demo-simple-select-label"
                      id="demo-simple-select"
    ...
    export default Engineeringstudent;
